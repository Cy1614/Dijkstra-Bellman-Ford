...
# Bellman-Ford algorithm's running time is approximately exp(O(n)) times Dijkstra's runtime but the advantage of this
# algorithm is that it can deal with graphs with negative weights
...
if __name__ == '__main__':
    ...
    # np.tril/triu generates lower/upper triangle of an array
